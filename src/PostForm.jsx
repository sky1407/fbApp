...
function PostForm({ onAddPost }) {
  ...
  return (
    <div className="mb-8 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 shadow-sm rounded-xl p-5">
      <h3 className="text-lg font-bold text-gray-800 dark:text-zinc-100 mb-4">Create new post</h3>
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label className="block text-xs font-semibold uppercase tracking-wider text-gray-500 mb-1">Image URL (thumbnail)</label>
          <input 
            type="text" 
